...
public class QuestionVo {
    ...
    @Valid private List<QuestionDetailVo> questionDetail;
    ...
    public static QuestionVo of(
            ApplicationQuestion applicationQuestion, List<QuestionDetailVo> questionDetailVos) {
