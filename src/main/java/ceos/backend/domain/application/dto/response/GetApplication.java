...
public class GetApplication {
    @JsonUnwrapped private ApplicantInfoVo applicantInfoVo;
    @JsonUnwrapped private ApplicationDetailVo applicationDetailVo;
    ...
    private GetApplication(
            ...
            ApplicationDetailVo applicationDetailVo,
            List<QnAVo> commonQuestions,
            List<QnAVo> partQuestions,
            List<InterviewTimeVo> times) {
    ...
    public static GetApplication of(
