...
public class ProjectRequest {
    ...
    @JsonUnwrapped private ProjectInfoVo projectInfoVo;

    @Valid private List<ProjectUrlVo> projectUrls;

    @Valid private List<ProjectImageVo> projectImages;

    @Valid private List<ParticipantVo> participants;
}
