...
public class AwardsRequest {
    ...
    @Builder
    public AwardsRequest(int generation, String startDate, List<String> content) {
        this.generation = generation;
        this.startDate = startDate;
        this.content = content;
    }

    public static AwardsRequest of(int generation, String startDate, List<String> content) {
